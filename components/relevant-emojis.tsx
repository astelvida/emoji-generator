...
import { getPopularEmojis } from "@/db/queries";
...
export async function RelevantEmojisGrid({ emojiId }: EmojisGridProps) {
  const title = emojiId ? "Related emojis" : "Popular emojis";
  const emojis = await getPopularEmojis();
